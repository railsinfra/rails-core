...
mod tests {
    ...
    fn defaults_are_applied_when_env_is_absent() {
        ...
        std::env::remove_var(OUTBOUND_RECONCILE_INTERVAL_SECS_ENV);
        std::env::remove_var(TRANSACTION_POSTING_STALE_AFTER_SECS_ENV);
        std::env::remove_var(OUTBOUND_MAX_PENDING_AGE_SECS_ENV);
